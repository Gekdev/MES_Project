					...
					<div class="modal-content">
						...
						<div class="row g-3">			
							<div class="form-group">
								<label for="board_title" class="col-lg-2 form-label">제목</label>
								<div class="col-lg-10 tt_1">	
						      		<input class="form-control" type="text" id="board_title" name="boardTitle" value="${board.boardTitle}">
						   		</div>
							</div>
							<div>
						  		<label for="board_content form-label">내용</label>
						  		<div id="provision">
						      		<textarea class="form-control bc_1" style="resize:none" id="board_content" name ="boardContent">${board.boardContent}</textarea>
						  		</div>
							</div>
							<div>
							...
							<div class="form-group">
						  		<label for=member_file class="col-lg-2 form-label">파일</label>
						  		<div>
						      		<input class="form-control" id="fileAttachment" type="file" name="fileUpload" multiple="multiple" />
						  		</div>
							</div>
							<div class="form-group">
