						...
						<form action="boardinsert.do" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-lg-10 tt_1">	
						      		<input type="text" id="board_title" class="form-control" name="boardTitle">
						   		</div>
							</div>
							<div>
						  		<label for="board_content" class="form-label">내용</label>
						  		<div id="provision form-control">
						      		<textarea class="form-control bc_1" cols= "100" style="resize:none" id="board_content" name ="boardContent"></textarea>
						  		</div>
							</div>
							<div>
						  		<label for=member_file class="col-lg-2 form-label">파일</label>
						  		<div>
						      		<input id="fileAttachment form-control" type="file" name="fileUpload" multiple="multiple" />
						  		</div>
							</div>
